...
class ActionColumn extends Column
{
     ...
     * @see buttons
     */
    public $template = '{view} {update} {delete} {print}';
    /**
    ...
    public $icons = [
        ...
        'print' => '<svg aria-hidden="true" style="display:inline-block;font-size:inherit;height:1em;overflow:visible;vertical-align:-.125em;width:.875em" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M448 64H64C28.65 64 0 92.65 0 128V384C0 419.3 28.65 448 64 448H144V368C144 345.9 161.9 328 184 328H328C350.1 328 368 345.9 368 368V448H448C483.3 448 512 419.3 512 384V128C512 92.65 483.3 64 448 64zM368 448H144V368C144 345.9 161.9 328 184 328H328C350.1 328 368 345.9 368 368V448zM160 288C151.2 288 144 280.8 144 272C144 263.2 151.2 256 160 256H352C360.8 256 368 263.2 368 272C368 280.8 360.8 288 352 288H160zM384 96C392.8 96 400 103.2 400 112C400 120.8 392.8 128 384 128H128C119.2 128 112 120.8 112 112C112 103.2 119.2 96 128 96H384zM368 448H144V368C144 345.9 161.9 328 184 328H328C350.1 328 368 345.9 368 368V448zM416 288C407.2 288 400 280.8 400 272C400 263.2 407.2 256 416 256H96C87.2 256 80 263.2 80 272C80 280.8 87.2 288 96 288H416z"/></svg>',
    ...
    protected function initDefaultButtons()
    {
        ...
        $this->initDefaultButton('print', 'print', [
            'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this item?'),
            'data-method' => 'post',
        ]);
